 ...
 * will see 3 ways to create MD5 hash or digest using standard Java API, Spring
 * framework and open source library, Apache commons codec utilities. Generally
 * MD5 has are represented as Hex String so each of this function will return
...
public class MD5Hash {
	...
	/*
	 * Apache commons code provides many overloaded methods to generate md5 hash. It
	 * contains md5 method which can accept String, byte[] or InputStream and can
	 * return hash as 16 element byte array or 32 character hex String.
	 */
